...
if __name__=='__main__':
    ...
    C = sc.textFile(sys.argv[1] if len(sys.argv)>1 else '/shared/CUSP-GX-6002/data/complaints.csv', use_unicode=True).cache()
    ...
    D1 = D.map(lambda x: (x[0].strip().lower(),x[1],x[2].strip().lower()))\
          .distinct()\
